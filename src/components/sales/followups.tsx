...
function seed(): Reminder[] {
  const base: Omit<Reminder, "id" | "timeline" | "status" | "rescheduleCount" | "originalDueAt">[] = [
    ...
    { leadId: "CC-1051", leadName: "Meena Agarwal", phone: "9823012345", city: "Indore", unit: "Franchise", source: "Website", stage: "Engagement Letter Pending", type: "Payment follow-up", priority: "Urgent", purpose: "Collect engagement letter fee", dueAt: iso(-320), owner: "Rahul Mehta", alertTiming: "1 hour before", repeat: "Daily", notes: "Said payment would be done from HDFC account.", lastInteraction: "WhatsApp · yesterday" },
